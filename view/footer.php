<footer>
    ...
    <div class=footer-1>
        <div class="footer-nav">
            ...
            <ul>
                <li><a href="./index.php?act=product&nav=brand&type=loreal">L'OREAL</a></li>
                <li><a href="./index.php?act=product&nav=brand&type=cocoon">Cocoon</a></li>
                <li><a href="./index.php?act=product&nav=brand&type=larocheposay">LA ROCHE-POSAY</a></li>
                <li><a href="./index.php?act=product&nav=brand&type=bioderma">BIODERMA</a></li>
                <li><a href="./index.php?act=product&nav=brand&type=maybelline">MAYBELLINE</a></li>
                <li><a href="./index.php?act=product&nav=brand&type=mac">M.A.C</a></li>
            </ul>
        </div>
        <div class="footer-nav">
    ...
    <div class=footer-2>
        <p class="credit">Trang web thuộc quyền sở hữu của công ty FLORA</p>
        <div>
            <p><strong>Trụ sở chính - TP.HCM</strong></p>
            <p><strong>Địa chỉ:</strong> 273 An Dương Vương, Phường 3, Quận 5, Thành phố Hồ Chí Minh</p>
            <p><strong>Số điện thoại:</strong> 012345678</p>
        </div>
        <div>
            <p><strong>Trụ sở 1 - TP.HCM</strong></p>
            <p><strong>Địa chỉ:</strong> 105 Bà Huyện Thanh Quan, Võ Thị Sáu, Quận 3, Thành phố Hồ Chí Minh
            </p>
            <p><strong>Số điện thoại:</strong> 012345678</p>
        </div>
        <div>
            <p><strong>Trụ sở 2 - TP.HCM</strong></p>
            <p><strong>Địa chỉ:</strong> 4 Tôn Đức Thắng, Bến Nghé, Quận 1, Thành phố Hồ Chí Minh</p>
            <p><strong>Số điện thoại:</strong> 012345678</p>
        </div>
    </div>
</footer>