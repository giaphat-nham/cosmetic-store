...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2023 at 05:41 PM
...
(1, 'account manager'),
(2, 'product manager'),
(3, 'decentralization manager'),
(4, 'product type manager');
...
--
ALTER TABLE `feature`
  MODIFY `feature_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
